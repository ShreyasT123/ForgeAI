...
<Card title="Tutorial: Build a SQL assistant with on-demand skills" icon="wand" href="/oss/javascript/langchain/multi-agent/skills-sql-assistant" arrow cta="Learn more">
